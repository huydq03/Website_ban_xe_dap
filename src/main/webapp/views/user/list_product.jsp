                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <li class="page-item ${pageNum==1?'disabled':''}"><a class="page-link"
                                                     href="${pageContext.request.contextPath}/product/list?pageNum=${pageNum == 1 ? 1 : pageNum-1}">Pre</a>
                            </li>
                            ...
                            <li class="page-item ${pageNum==totalPage?'disabled':''}"><a class="page-link"
                                                     href="${pageContext.request.contextPath}/product/list?pageNum=${pageNum == totalPage ? totalPage : pageNum+1}">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
