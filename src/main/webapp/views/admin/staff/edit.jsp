        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Cập nhật nhân viên</h1>
                    ...
                    <frm:form method="POST"
                        ...
                        <div class="col-md-2">
                            ...
                            <br>
                            <frm:radiobutton path="gender" value="1" checked="${users.gender == 1 ? 'checked':''}"/>Nam
                            <frm:radiobutton path="gender" value="0" checked="${users.gender == 0 ? 'checked':''}"/>Nữ
                        </div>
                        <div class="col-md-3">
                            <label for="validationCustom19" class="form-label">Số điện thoại</label>
                            <frm:input type="text" class="form-control" path="phone" id="validationCustom19"
                                       value="${users.phone}"/>
                        </div>
                        <div class="col-md-6">
                        </div>
                        ...
                        <div class="col-md-2" style="margin-top: 20px">
                            ...
                            <frm:select class="form-select" id="validationCustom10" path="role">
                                <frm:option value="0"
                                            selected="${users.role == 0 ? 'selected' : ''}">Quản lý</frm:option>
                                <frm:option value="1"
                                            selected="${users.role == 1 ? 'selected' : ''}">Nhân viên</frm:option>
                            </frm:select>
                        </div>
